...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (api?.offline && session?.person_id !== 'offline') (setSession({ person_id: 'offline', token: 'offline' }), setOnboarding(false))
  }, [api, session])
  ...
  const intake = onboarding && (showOffering || !!connecting) // nothing of the app itself shows behind the intake pages
